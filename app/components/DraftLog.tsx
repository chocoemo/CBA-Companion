  ...
  return (
    <div>
      ...
      <table className="data-table" style={{ marginBottom: 24 }}>
        <thead>
          <tr>
            <th>Rd</th><th>Pick</th><th className="left">Team</th><th className="left">Player</th>
            <th>Pos</th><th>Age</th><th>Assign to</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((r) => (
            <tr key={r.id}>
              <td>{r.round}</td>
              <td>{r.overallSlot}</td>
              <td className="left">{r.team.abbr}</td>
